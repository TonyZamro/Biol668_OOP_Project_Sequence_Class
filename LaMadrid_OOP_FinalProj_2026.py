...
#      This include the 3 forward frames, and the 3 reverse complement frames
    ...
    def __init__(self,sequence,gene,species,geneid,kmers=[],**kwargs):
        ...
        self.sequence=re.sub('[^ATGCU]','N',sequence.strip().upper())
        self.geneid=geneid
        self.kmers=kmers
    ...
    def six_frames(self):
        ...
        frames.append(self.reverse_complement())
        frames.append(self.reverse_complement()[1:])
        frames.append(self.reverse_complement()[2:])
        print(frames)
        return frames
...
#      translate the codons in self.codons and returns a protein sequence.
    ...
    def __init__(self,sequence,gene,species,geneid,kmers=[],codons=[],**kwargs):
